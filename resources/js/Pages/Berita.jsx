...
export default function Berita({ posts, filters = {} }) {
  ...
  // Data postingan (mendukung pagination standar Laravel / array langsung)
    ...
    <div className="bg-gray-50 min-h-screen font-sans text-gray-800 flex flex-col justify-between">
      ...
      <main className="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 w-full">
        ...
        <div className="mb-12 text-center flex flex-col items-center">
          ...
          {/* Tag Filter Aktif (Tampil jika kategori atau arsip diklik) */}
        ...
        {/* DAFTAR KARTU BERITA: OTOMATIS RATA TENGAH (FLEX WRAP + JUSTIFY CENTER) */}
        {dataBerita.length > 0 ? (
